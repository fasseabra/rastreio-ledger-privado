...
//#region node_modules/.nitro/vite/services/ssr/assets/router-D77biUZg.js
...
function formatDecimal(value, digits = 1, locale = "pt-BR") {
...
var TooltipContent = import_react.forwardRef(({ className, sideOffset = 8, ...props }, ref) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Portal, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Content2, {
	ref,
	sideOffset,
	className: cn("z-50 max-w-xs rounded-md bg-popover px-3 py-2 text-xs text-popover-foreground shadow-[var(--shadow-border)]", "origin-[var(--radix-tooltip-content-transform-origin)]", "data-[state=delayed-open]:animate-in data-[state=delayed-open]:fade-in-0 data-[state=delayed-open]:zoom-in-95", "data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=closed]:zoom-out-95", className),
	...props
}) }));
TooltipContent.displayName = Content2.displayName;
var styles_default = "/assets/styles-Cii3wvo-.css";
var APP_NAME = "Rastro";
var APP_DESCRIPTION = "Explicação interativa do artigo Foods 2025 sobre rastreabilidade alimentar com blockchain privada, IoT e Hyperledger Fabric.";
...
var $$splitComponentImporter = () => import("./routes-DNd5GhWR.mjs");
...
//#endregion
export { formatNumber as i, cn as n, formatDecimal as r, router_exports as t };
